...
String ss=request.getParameter("cartid");
%>
...
<form action="paymentac2.jsp"  onsubmit="required()" method="post">
<div class="myDiv">
<table>
<%-- <tr>

<td><input type="text"  placeholder="cardholdername" name="pid" value="<%=id %>" style="width:180px;height:30px;border-radius: 10px;text-align:center;"  required><br><br></td>
</tr> --%>
<%-- <tr>

<td><input type="text"  placeholder="cardholdername" name="t6" value="<%=t6 %>" style="width:180px;height:30px;border-radius: 10px;text-align:center;"  required><br><br></td>
</tr> --%>
<tr>

<td><input type="hidden"  placeholder="cardholdername" name="cartid" value="<%=ss %>" style="width:180px;height:30px;border-radius: 10px;text-align:center;"  required><br><br></td>
</tr>

<tr>
<lable>AMOUNT</lable><br>
<td><input type="text"  placeholder="enter amount" name="amt" value="<%=userid %>" style="width:180px;height:30px;border-radius: 10px;text-align:center;"  required><br><br></td>
</tr>
...
<tr>
<!-- <td colspan="2"><input type="submit" value="Generate QR" style="width:110px;height:40px;border-radius: 10px;text-align:center; background-color: #ffb84d" required></td> -->
</tr>
